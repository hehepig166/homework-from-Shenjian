...
int main()
{
    ...
    if (1)
    {
        ...
        cout << "append简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
    ...
    if (1)
    {
        ...
        cout << "append综合测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
        ...
        s = NULL;
        cout << "s应该是3.心也可以清!，实际输出：" << ((s.assign("3.")).append(str4 + s5 + s1.c_str() + str2 + s3 + c)) << endl;
    ...
    {
        TStringAdv s1;
        const TStringAdv s2 = "eon";
        const char* str3 = " not", str4[] = "?";
        const char c = 'n';

        cout << "insert简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Peppa is a pigeon ?， 实际输出：" << (s1.insert(s2, 15)) << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Peppa is not a pig ?,  实际输出：" << (s1.insert(str3, 9)) << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Peppa is a pig ??,  实际输出：" << (s1.insert(str4, 16)) << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Peppa is an pig ?， 实际输出：" << (s1.insert(c, 11)) << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Peppa is a pig ?， 实际输出：" << (s1.insert(c, 178)) << endl;
    ...
    if (1)
    {
        TStringAdv s1, s3 = "wa";
        const TStringAdv s2 = "eon";
        const char* str3 = "g", str4[] = "?";
        const char c = 'n';

        cout << "insert综合测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;

        s1 = "Peppa is a pig ?";
        cout << "s1应为Wow !Peppa is a pigeon ?， 实际输出：" << ((s1.insert(s2, 15)).insert("Wow !", 1)) << endl;

        s1 = "eg:";
        cout << "s1应为eg:Are you ok ?eg:Are you ok ?,  实际输出：" << (s1.insert(s1.insert("Are you ok ?", 4), 1)) << endl;

        s1 = "eg: ";
        cout << "s1应为eg:Peppa is a pigeonwang?,  实际输出：" << ((((s1.insert(s2, 4)).insert("Peppa is a pig", 4)).insert(((s3.insert(str4, 3)).insert(str3, 3)).insert(c, 3), 21)).insert("lalala", -1)) << endl;
    ...
    if (1)
    {
        ...
        cout << "erase简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
        ...
        s1 = "This is a red pencil";
        cout << "s1应为<NULL>，             实际输出：" << (s1.erase(s1)) << endl;
    ...
    if (1)
    {
        TStringAdv s1 = "house*near*the*sea";
        TStringAdv s2[4] = { "yangpu", "sipingroad", "tongji", "shanghai" };
        int i;

        cout << "substr测试" << endl;

        cout << "串1是" << s2[2] << "，依次打印其每个字符开始的长度为5的子串结果是(除第二、三个外其余均应为\"非法\")：";
        for (i = 0; i <= s2[2].length(); i++)
        {
            TStringAdv sr = s2[2].substr(i, 5);
            if (sr.length() != 0)
                cout << sr << ' ';
            else
                cout << "非法 ";
        ...
        cout << "串2是" << s1 << "，依次打印其每个字符开始的长度为1的子串的结果是(第一个和最后一个应为\"非法\")：";
        for (i = 0; i <= s1.length() + 1; i++)
        {
            TStringAdv sr = s1.substr(i, 1);
            if (sr.length() != 0)
                cout << sr << ' ';
            else
                cout << "非法 ";
        ...
        cout << "串3是" << s2[3] << "，依次打印其每个字符开始的直到结尾的子串的结果是(第一个和最后一个应为\"非法\")：";
        for (i = 0; i <= s2[3].length() + 1; i++)
        {
            TStringAdv sr = s2[3].substr(i);
            if (sr.length() != 0)
                cout << sr << ' ';
            else
                cout << "非法 ";
