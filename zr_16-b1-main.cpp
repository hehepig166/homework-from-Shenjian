/*2050271 信20 张睿*/
/*20533398 马启越,20532316 李祎娜,2051837 覃政，2053021_周震东*/ 
...
//		cout << "s1应为HelloHello!HelloHello!HelloHello!，实际输出：" << (((s1 *= 2) + '!') *= 3) << endl;
	...
	if (1) {
		...
		cout << "自连接(append()简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {
		...
		cout << "自连接(append()综合测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {
		...
		cout << "插入(insert()简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;

		TStringAdv s1 = "to", s2 = "ng", s3 = "ji ", s4 = "NO.1";
		s2.insert(s1, 1);
		s2.insert(s4, 5);
		s2.insert(s3, 5);
		cout << "s应该是tongji NO.1，实际输出：" << s2 << endl;

		const char* str1 = "to", * str3 = "ji ", * str4 = "NO.1";
		TStringAdv str2 = "ng";
		str2.insert(str1, 1);
		str2.insert(str4, 5);
		str2.insert(str3, 5);
		cout << "s应该是tongji NO.1，实际输出：" << str2 << endl;
		...
		c2.insert(c4, 3);
		c2.insert(c3, 3);
		cout << "s应该是tong，实际输出：" << c2 << endl;

		TStringAdv err = "tongji";
		err.insert('\0', 1);
		err.insert('\0', 7);
		err.insert('\0', 3);
		cout << "s应该是tongji，实际输出：" << err << endl;

		TStringAdv err1 = "tongji";
		err1.insert(TStringAdv("uu"), 0);
		err1.insert("54", 8);
		err1.insert('i', -5);
		//err1.insert(NULL, 12);
		cout << "s应该是tongji，实际输出：" << err1 << endl;
	...
	if (1)
	{
		cout << "插入(insert()综合测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
		TStringAdv s1 = "ng";
		s1.insert("to", 1).insert(TStringAdv("ji"), 5).insert(' ', 7).insert("NO.1", 8).insert("开始", 0).insert("开始", 20);
		cout << "s应该是tongji NO.1，实际输出：" << s1 << endl;

		TStringAdv s2 = "请", s3 = "你", s4 = "的演", s5;
		s5 = (s4.insert("表", 3)).insert(s3.insert(s2.insert("开始", 3), 1), 1);
		cout << "s应该是:请开始你的表演，实际输出：" << s5 << endl;
	...
	if (1)
	{
		...
		TStringAdv s1 = "this is an apple,i like apples";

		cout << "s1应为:this is an apple,i like apples,实际输出：" << s1.substr(1) << endl;
		cout << "s1应为: is an apple,i like apples    ,实际输出：" << s1.substr(5) << endl;
		cout << "s1应为: is a                         ,实际输出：" << s1.substr(5,5)<< endl;
		cout << "s1应为:s                             ,实际输出：" << s1.substr(30, 5)<< endl;
		cout << "s1应为:<NULL>                        ,实际输出：" << s1.substr(30, 0)<< endl;
		cout << "s1应为:<NULL>                        ,实际输出：" << s1.substr(35, 5)<< endl;
		cout << "s1应为:<NULL>                        ,实际输出：" << s1.substr(0, 5)<< endl;
		cout << "s1应为:<NULL>                        ,实际输出：" << s1.substr(-1, 5)<< endl;
		cout << "s1应为:<NULL>                        ,实际输出：" << s1.substr(8, -1)<< endl;
		wait_for_enter();
	}
