...
void hehepig_test()
{
    int num = 0;
    puts("===========================================================================");
    puts("2051995 的测试开始，可根据编号与代码行数快速对应");
    puts("===========================================================================");
    TStringAdv a, b;
    TString c = "hehepig";
    char *pn = NULL;

    cout << ++num << "\t应该是 123          实际是 " << TStringAdv("123") << endl;
    cout << ++num << "\t应该是 123          实际是 " << TStringAdv(TString("123")) << endl;
    cout << ++num << "\t应该是 <NULL>       实际是 " << TStringAdv(TString(NULL)) << endl;
    cout << ++num << "\t应该是 <NULL>       实际是 " << a << endl;
    cout << ++num << "\t应该是 <NULL>       实际是 " << a.assign(TStringAdv()) << endl;
    cout << ++num << "\t应该是 <NULL>       实际是 " << a.assign("") << endl;
    cout << ++num << "\t应该是 <NULL>       实际是 " << a.assign('\0') << endl;
    cout << ++num << "\t应该是 he           实际是 " << a.assign("he") << endl;
    cout << ++num << "\t应该是 he           实际是 " << a.at(0) << a[1] << endl;
    cout << ++num << "\t应该是 hehe         实际是 " << a.assign(TStringAdv(TString(NULL) + 'h').assign(TStringAdv(("" + (b = a * 2)) * 2).erase("hehe"))) << endl;
    cout << ++num << "\t应该是 hehep        实际是 " << a.append('p') << endl;
    cout << ++num << "\t应该是 hehepi       实际是 " << !((TStringAdv(!a)).insert('i', 1)) << endl;
    cout << ++num << "\t应该是 hehepi       实际是 " << (a = !(((TStringAdv(!a) -= "pdd" - TStringAdv("dd") + TStringAdv("e").append('h')).append("eh").insert("ip", 1)))) << endl;
    cout << ++num << "\t应该是 hehepi       实际是 " << (a += "gg") - 'g' << endl;
    cout << ++num << "\t应该是 hehepigg     实际是 " << a << endl;
    cout << ++num << "\t应该是 hehepigfgh   实际是 " << a.insert("f", a.length()).insert("j", 11).insert("h", 10) << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << a.substr(1, 7) << endl;
    cout << ++num << "\t应该是 fghhehepig23 实际是 " << (TStringAdv((a *= 2) + "123").erase("hehepig") - "fgh1") << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << (a.erase(TStringAdv("fh").assign(pn).append("h") + TString("hehepig")) - TString("fgfgh")) << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << c + TStringAdv(pn) << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << TStringAdv(pn) + c << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << c - TStringAdv("") << endl;
    cout << ++num << "\t应该是 hehepig      实际是 " << TString("hehepig") + TStringAdv(pn) << endl;
    cout << ++num << "\t应给是 abc          实际是 " << TString("abcd") - TString("cd") + TStringAdv("cg") - TString("g") << endl;


    puts("");
    puts("===========================================================================");
    puts("2051995 的测试结束，回车继续");
    puts("===========================================================================");
    puts("");
    puts("");
    getchar();
